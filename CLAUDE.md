...
- `docs/plan/` says **when**. Tasks are `YQM-NN`, numbered continuously, one task per commit. Milestones E0–E4 and E4a have tasks written out and are finished; E5 and E6 have a goal and mandatory acceptance scenarios.
