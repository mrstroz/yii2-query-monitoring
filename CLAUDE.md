...
- `docs/plan/` says **when**. Tasks are `YQM-NN`, numbered continuously, one task per commit. Milestones E0–E4 have tasks written out and are finished; E5 and E6 have a goal and mandatory acceptance scenarios.
