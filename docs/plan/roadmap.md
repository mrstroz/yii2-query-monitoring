...
| Pole | Wartość |
|---|---|
| **Etap** | E0. Fundament i źródło SQL, w toku, 0 z 12 |
| **Ostatnio ukończone** | nic |
| **Następne** | [YQM-1](01-fundament-i-sql.md) szkielet pakietu z narzędziami. Po nim YQM-2 i YQM-6 mogą iść równolegle |
...
|---|---|---|---|---|
| **E0** | [01-fundament-i-sql](01-fundament-i-sql.md) | Pakiet, kolektor, `Command`, cykl życia HTTP | Aplikacja z MySQL i PostgreSQL daje paczkę do jawnego adaptera, wyjątek nie gubi paczki | 0/12 |
