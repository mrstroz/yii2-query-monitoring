...
| Pole | Wartość |
|---|---|
| **Etap** | E4. Źródło MongoDB, 3 z 10 |
| **Ostatnio ukończone** | [YQM-33](05-mongodb.md): `QueryMonitor` oddaje każde połączenie z listy pierwszemu źródłu z `createSources()`, które je przyjmuje (`SourceInterface`); źródło SQL to `sql\Source`. Yii bez pól z ADR-0001 wyłącza tylko źródło SQL |
| **Następne** | [YQM-34](05-mongodb.md): normalizator MongoDB, najpierw poprawka [spec 02 §4](../spec/02-format-paczki.md#4-normalizacja) |
...
| **E4** | [05-mongodb](05-mongodb.md) | Źródło MongoDB | Jedna paczka z wpisami SQL i MongoDB | 3/10 |
