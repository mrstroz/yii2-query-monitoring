...
| Pole | Wartość |
|---|---|
| **Etap** | E0. Fundament i źródło SQL, w toku, 3 z 12 |
| **Ostatnio ukończone** | [YQM-3](01-fundament-i-sql.md): kolektor z limitami, JSON nigdy ponad `maxBatchBytes` |
| **Następne** | [YQM-6](01-fundament-i-sql.md) normalizator SQL. Komendy przez Docker: `docker compose run --rm php composer test` |
...
|---|---|---|---|---|
| **E0** | [01-fundament-i-sql](01-fundament-i-sql.md) | Pakiet, kolektor, `Command`, cykl życia HTTP | Aplikacja z MySQL i PostgreSQL daje paczkę do jawnego adaptera, wyjątek nie gubi paczki | 3/12 |
