...
| Pole | Wartość |
|---|---|
| **Etap** | E4. Źródło MongoDB, 2 z 10 |
| **Ostatnio ukończone** | [YQM-32](05-mongodb.md): sonda sterownika, otwarta kwestia 2 w [spec 00 §9](../spec/00-przeglad-i-zakres.md#9-otwarte-kwestie) zamknięta. Subskrybent na `Connection::$manager` w `EVENT_AFTER_OPEN`, jeden subskrybent na klucz klienta sterownika ([ADR 0010](../adr/0010-subskrybent-na-manager-polaczenia-mongodb.md)), dokumenty poleceń w `tests/fixtures/mongodb-commands.json` |
| **Następne** | [YQM-33](05-mongodb.md): instalacja źródła SQL wydzielona z `QueryMonitor` za interfejs źródła |
...
| **E4** | [05-mongodb](05-mongodb.md) | Źródło MongoDB | Jedna paczka z wpisami SQL i MongoDB | 2/10 |
