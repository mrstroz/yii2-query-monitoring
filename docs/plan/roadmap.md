...
| Pole | Wartość |
|---|---|
| **Etap** | E3. Kontekst wpisu i limity, 4 z 4, zakończony. Następny E4. Źródło MongoDB |
...
| **Następne** | Rozpisać zadania E4 w [05-mongodb.md](05-mongodb.md). Pierwsze to sonda z otwartej kwestii 2 w [spec 00 §9](../spec/00-przeglad-i-zakres.md#9-otwarte-kwestie): czy `yii\mongodb\Connection` udostępnia `Manager` do `addSubscriber` |
