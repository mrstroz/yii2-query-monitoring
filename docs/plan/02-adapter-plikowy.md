...
- [ ] (^) **YQM-13** Klasa `FileAdapter` zapisująca paczkę jako wiersz JSON pod nieblokującą blokadą
...
- [ ] (=) **YQM-14** Rotacja po rozmiarze pod tą samą blokadą
...
- [ ] (=) **YQM-15** Adapter plikowy jako domyślny w komponencie, z kluczem `file`
...
- [ ] (^) **YQM-16** Uruchamianie wielu skryptów PHP naraz, ze wspólną barierą startu
...
- [ ] (=) **YQM-17** Ochrona aplikacji z adapterem plikowym w osobnym procesie
...
- [ ] (=) **YQM-18** Osiem równoległych procesów z rotacją bez utraty wiersza poza zajętą blokadą
