 ...
 *
 * A single pass over the bytes: literals become `?`, comments and runs of whitespace become one
 * space, everything else is copied. Anything the scanner is not sure about gives `null`.
 */
